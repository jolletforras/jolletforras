...
<br><br>
<a href="https://tarsadalmijollet.hu/profil/{{ $commenter_id }}">{{$commenter_name}}</a> a következőket írta:<br>
...
<br><br>
A válaszoláshoz bejelentkezés szükséges. A válaszoláshoz a "Válaszolok" gombra kattints, ha a tarsadalmi.jollet@gmail.com címre válaszolsz, azt a többiek nem fogják látni. Ha nem szeretnél a jövőben értesítéseket kapni, kattints <a href="{{url('/profilom')}}/beallitasok">IDE</a> és szedd ki az értesítésnél a pipát.