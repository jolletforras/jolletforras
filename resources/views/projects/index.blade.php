@extends('layouts.app')
@section('description', 'Kezdeményezések a Jóllét Forrás oldalon. Milyen legyen az új világunk? Ismerd meg a Jóllét Forrás oldal tagjainak kezdeményezéseit, csatlakozz hozzánk, vedjél részt bennük, hozd létre a sajátod. Várunk!')
@section('url', 'https://jolletforras.hu/kezdemenyezesek')
@section('canonical')<link rel="canonical" href="https://jolletforras.hu/kezdemenyezesek" /> @endsection
...
@section('content')
	...
	<div class="inner_box @if($logged_in)collapse @endif" id="project_info">
		Itt a Jóllét Forrás oldal tagjainak saját kezdeményezéseit találod. A kezdeményezés lehet:<br>
		<ul>
			...
			<li>olyan program, cselekvés, ami már működik és a kezdeményezés tagjai szeretnék ezt megmutatni a Jóllét Forrás oldalon</li>
		</ul>
