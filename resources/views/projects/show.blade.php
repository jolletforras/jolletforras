...
@section('content')
	...
	<div class="inner_box narrow-page" style="margin-top:6px;">
		...
		@endif
			...
			@if(!empty($project->my_undertake))
			<p><b>Amit a kezdeményező hozzá tud tenni a megvalósításhoz</b><br>{!! nl2br($project->my_undertake) !!}</p>
			@endif
			<p><b>Társak akiket várnak</b><br>{!! nl2br($project->looking_for) !!}</p>
