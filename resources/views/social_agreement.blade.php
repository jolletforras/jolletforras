   		...
   		<div class="inner_box narrow-page">
            ...
            <ul style="padding-left: 25px;">
                ...
                <li><b>Tiszta, átlátható működés és kommunikáció</b><br>
                    A portál áttekinthetően működik (lásd <a href="{{ url('/') }}/tudnivalok " target="_blank">tudnivalók</a> és <a href="{{ url('/') }}/adatkezeles " target="_blank">adatkezelés</a>), folyamatai átláthatóak. </li>
