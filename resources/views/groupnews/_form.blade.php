		...
		<div class="form-group">
			...
			<div id="public_info" class="collapse info">Ha a láthatóság "csoport", akkor csak a csoport számára elérhető a hír; ha "portál" akkor minden regisztrált számára; ha "nyilvános" akkor a nem regisztráltak számára is látható.</div>
		</div>
